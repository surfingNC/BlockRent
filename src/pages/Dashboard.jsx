...
useEffect(() => {
  ...
  return (
    <div
      style={{
        backgroundImage: `url(${process.env.PUBLIC_URL + '/backgroundFiller.PNG'})`, // ✅ from public
    ...
    >
      <div className="app-container">
        <h1 style={{ textAlign: 'center' }}>Welcome, {username || 'User'}!</h1>
        ...
        <div style={{ marginTop: '40px' }}>
          ...
          {btcEstimate && (
            <p>
              ...
              {btcUsdRate &&
                `$${(btcEstimate.btcRequired * parseFloat(btcUsdRate)).toFixed(2)}`}
              )
            </p>
          )}
        </div>
